...
namespace IsaacSaveFileCrc
{
    class Program
    {
        static void Main(string[] args)
        {
            if (args.Length != 1)
            {
                Console.WriteLine("Drag the isaac save file you want to resign onto this executable.");
                Console.ReadLine();
                return;
            }
            ...
            if (data.Length < 20 || Encoding.ASCII.GetString(data, 0, 16) != "ISAACNGSAVE09R  ")
            {
                Console.WriteLine("Invalid or unsupported save file");
                Console.ReadLine();
            }

            Console.WriteLine("Make sure to always backup your save file. Press enter to continue");
            Console.ReadLine();
            ...
            Console.WriteLine("Successfully updated the CRC");
            Console.ReadLine();
        }
